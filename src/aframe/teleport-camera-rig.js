...
AFRAME.registerComponent('teleport-camera-rig', {
    ...
    schema: {
      ...
      on: {type: 'string', default: 'teleport'},
    ...
    onEvent: function () {
        ...
        this.data.camera.setAttribute("simple-navmesh-constraint","enabled",false);
    ...
    queueMicrotask(() => {  
        this.data.camera.setAttribute("simple-navmesh-constraint","enabled",true);}
    );
