...
<template>
  <a-scene background="color: black;" renderer="colorManagement: true;">
    <a-assets @loaded="allAssetsLoaded = true">
      ...
      <a-asset-item
        id="cave"
        src="assets/the_queen_of_the_caverns.glb"
      ></a-asset-item>
      ...
      <a-asset-item
        id="gold-bar"
        src="assets/gold_bar_low_poly.glb"
      ></a-asset-item>
    ...
    <template v-if="allAssetsLoaded">
      <a-entity
        position="-27 1.5 -3"
        animation="property: position; to: -27 1.8 -3; dur: 2000; easing: easeInOutSine; loop: true;"
      >
        <a-text value="Hello, world!" color="#000" align="center"></a-text>
      </a-entity>
